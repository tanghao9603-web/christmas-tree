...
//
const BASEDOCUMENT = import.meta.env.BASE_URL; // 等于 '/christmas-tree/'

const bodyPhotoPaths = [
  `${BASEDOCUMENT}photos/top.jpg`,
  ...Array.from({ length: TOTAL_NUMBERED_PHOTOS }, (_, i) => `${BASEDOCUMENT}photos/${i + 1}.jpg`)
];
